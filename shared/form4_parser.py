...
from shared.sec_api_helper import SecApiHelper  # ✅ 新增：辅助使用 SEC API
import traceback
...
def run_ceo_strategy(logger):
    ...
    try:
        ...
        downloaded_files = downloader.download_latest_form4(days_back=7, use_sec_api=True)  # ✅ 启用 SEC API
